...
## 🚀 Features
- 💻 Live code editor powered by [Monaco Editor](https://microsoft.github.io/monaco-editor/)
...
## 🛠️ Setup
1. Clone this repo
2. Setup Firebase and add your config to the frontend
3. Deploy backend (Node.js) on Replit or similar
4. Serve frontend via Firebase Hosting or GitHub Pages

## 📁 Folder Structure
/public → Frontend files
/functions → Firebase/Cloud Functions or backend logic
